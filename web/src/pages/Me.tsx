    ...
    <div className="max-w-[820px] mx-auto">
      ...
      {!connected ? (
        <Panel strong className="mt-6 p-6 md:p-8 text-center">
          ...
          <div className="mt-5 flex flex-col sm:flex-row gap-2.5 justify-center">
            ...
            <Button variant="glass" size="lg">I'm a KOL, claim with X</Button>
          </div>
        </Panel>
      ) : null}
      ...
      <div className="mt-6 grid gap-5 md:grid-cols-2">
        ...
        <div>
          ...
          <Empty title="No payouts yet" body="Fees are paid out automatically in ETH. You'll see every payout here." action={<Button variant="glass" size="sm" disabled>Withdraw</Button>} />
        </div>
      </div>
    </div>
  )
