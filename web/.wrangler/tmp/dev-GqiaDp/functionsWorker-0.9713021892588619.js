...
// .wrangler/tmp/pages-G4pWXX/functionsWorker-0.9713021892588619.mjs
...
async function signSession(secret, s) {
...
async function readSession(secret, cookieHeader) {
  ...
  try {
    const s = JSON.parse(atob(body.replace(/-/g, "+").replace(/_/g, "/")));
    if (!s.x || s.exp < Date.now() / 1e3) return null;
    return s;
  } catch {
    return null;
  }
...
var init_session = __esm({
  "_lib/session.ts"() {
    "use strict";
    init_functionsRoutes_0_6459104538277053();
    enc = new TextEncoder();
    __name2(hmac, "hmac");
    __name2(b64url, "b64url");
    __name2(signSession, "signSession");
    __name2(readSession, "readSession");
...
var init_callback = __esm({
  "api/x/callback.ts"() {
    ...
    onRequestGet = /* @__PURE__ */ __name2(async ({ request, env }) => {
      ...
      const session = await signSession(env.SESSION_SECRET, { x: me.data.username, xid: me.data.id, name: me.data.name, exp: Math.floor(Date.now() / 1e3) + 7 * 86400 });
...
var init_login = __esm({
  "api/x/login.ts"() {
    ...
    onRequestGet2 = /* @__PURE__ */ __name2(async ({ request, env }) => {
      ...
      const challenge2 = await sha256b64url(verifier);
      ...
      auth.searchParams.set("code_challenge", challenge2);
...
function parseAbi(signatures) {
  ...
  for (let i = 0; i < length; i++) {
    ...
    if (isStructSignature(signature))
      continue;
    abi3.push(parseSignature(signature, structs));
  }
  return abi3;
}
...
function getAbiItem(parameters) {
  const { abi: abi3, args = [], name } = parameters;
...
function encodeEventTopics(parameters) {
  const { abi: abi3, eventName, args } = parameters;
  let abiItem = abi3[0];
  if (eventName) {
    const item = getAbiItem({ abi: abi3, name: eventName });
    if (!item)
...
async function createContractEventFilter(client, parameters) {
  const { address, abi: abi3, args, eventName, fromBlock, strict, toBlock } = parameters;
...
function prepareEncodeFunctionData(parameters) {
  const { abi: abi3, args, functionName } = parameters;
  let abiItem = abi3[0];
  if (functionName) {
...
function encodeFunctionData(parameters) {
  ...
  const { abi: abi3, functionName } = (() => {
    if (parameters.abi.length === 1 && parameters.functionName?.startsWith("0x"))
      return parameters;
    return prepareEncodeFunctionData(parameters);
  })();
  const abiItem = abi3[0];
...
function decodeErrorResult(parameters) {
  const { abi: abi3, data, cause } = parameters;
  const signature = slice(data, 0, 4);
  if (signature === "0x")
    throw new AbiDecodingZeroDataError({ cause });
  const abi_ = [...abi3 || [], solidityError, solidityPanic];
...
var init_Value = __esm({
  "../node_modules/viem/_esm/utils/unit/Value.js"() {
    ...
    InvalidDecimalsError = class extends Error {
      static {
        __name(this, "InvalidDecimalsError");
      }
      static {
        __name2(this, "InvalidDecimalsError");
      }
...
__name(formatEther2, "formatEther2");
var init_formatEther = __esm({
  "../node_modules/viem/_esm/utils/unit/formatEther.js"() {
    init_functionsRoutes_0_6459104538277053();
    init_Value();
    __name2(formatEther2, "formatEther");
  }
});
function formatGwei2(wei, unit = "wei") {
  return formatGwei(wei, unit);
}
__name(formatGwei2, "formatGwei2");
var init_formatGwei = __esm({
  "../node_modules/viem/_esm/utils/unit/formatGwei.js"() {
    init_functionsRoutes_0_6459104538277053();
    init_Value();
    __name2(formatGwei2, "formatGwei");
  }
});
...
var FeePayerNonceMismatchError;
...
var init_transaction = __esm({
  "../node_modules/viem/_esm/errors/transaction.js"() {
    ...
    FeePayerNonceMismatchError = class extends BaseError2 {
      static {
        __name(this, "FeePayerNonceMismatchError");
      }
      static {
        __name2(this, "FeePayerNonceMismatchError");
      }
...
${prettyStateOverride(stateOverride)}`;
    ...
    ContractFunctionExecutionError = class extends BaseError2 {
      ...
      constructor(cause, { abi: abi3, args, contractAddress, docsPath: docsPath8, functionName, sender }) {
    ...
    ContractFunctionRevertedError = class extends BaseError2 {
      ...
      constructor({ abi: abi3, data, functionName, message, cause: error }) {
        let cause;
        let decodedData;
        let metaMessages;
        let reason;
        if (data && data !== "0x") {
          try {
            decodedData = decodeErrorResult({ abi: abi3, data, cause: error });
...
function getContractError(err, { abi: abi3, address, args, docsPath: docsPath8, functionName, sender }) {
...
var init_hmac = __esm({
  "../node_modules/@noble/hashes/esm/hmac.js"() {
    ...
    hmac2 = /* @__PURE__ */ __name2((hash3, key, message) => new HMAC(hash3, key).update(message).digest(), "hmac");
...
var init_utils4 = __esm({
  "../node_modules/@noble/curves/esm/abstract/utils.js"() {
    ...
    validatorFns = {
      ...
      stringOrUint8Array: /* @__PURE__ */ __name2((val) => typeof val === "string" || isBytes2(val), "stringOrUint8Array"),
...
function Field(ORDER, bitLen2, isLE2 = false, redef = {}) {
  ...
  const f = Object.freeze({
    ...
    toBytes: /* @__PURE__ */ __name2((num2) => isLE2 ? numberToBytesLE(num2, BYTES) : numberToBytesBE(num2, BYTES), "toBytes"),
...
function weierstrass(curveDef) {
  ...
  const slcNum = /* @__PURE__ */ __name2((b, from16, to) => bytesToNumberBE(b.slice(from16, to)), "slcNum");
  class Signature {
    static {
...
function getHash(hash3) {
  return {
    hash: hash3,
    hmac: /* @__PURE__ */ __name2((key, ...msgs) => hmac2(hash3, key, concatBytes(...msgs)), "hmac"),
    randomBytes
  };
}
...
var BaseFeeScalarError;
var Eip1559FeesNotSupportedError;
var MaxFeePerGasTooLowError;
var init_fee = __esm({
...
async function internal_estimateFeesPerGas(client, args) {
  ...
  const multiply = /* @__PURE__ */ __name2((base) => base * BigInt(Math.round(baseFeeMultiplier * denominator)) / BigInt(denominator), "multiply");
...
async function fillTransaction(client, parameters) {
  ...
  try {
    ...
    if (!hasFeePayerSignature) {
      ...
      const denominator = 10 ** decimals;
      const multiplyFee = /* @__PURE__ */ __name2((base) => base * BigInt(Math.round(feeMultiplier * denominator)) / BigInt(denominator), "multiplyFee");
...
var eip1559NetworkCache;
var supportsFillTransaction;
...
async function estimateContractGas(client, parameters) {
  const { abi: abi3, address, args, functionName, dataSuffix = typeof client.dataSuffix === "string" ? client.dataSuffix : client.dataSuffix?.value, ...request } = parameters;
...
function decodeEventLog(parameters) {
  const { abi: abi3, data, strict: strict_, topics } = parameters;
  const strict = strict_ ?? true;
  const [signature, ...argTopics] = topics;
  if (!signature)
    throw new AbiEventSignatureEmptyTopicsError({ docsPath: docsPath3 });
  const abiItem = abi3.find((x) => x.type === "event" && signature === toEventSelector(formatAbiItem2(x)));
...
function parseEventLogs(parameters) {
  const { abi: abi3, args, logs, strict = true } = parameters;
  const eventName = (() => {
  ...
  const abiTopics = abi3.filter((abiItem) => abiItem.type === "event").map((abiItem) => ({
    abi: abiItem,
...
async function getContractEvents(client, parameters) {
  const { abi: abi3, address, args, blockHash, eventName, fromBlock, toBlock, strict } = parameters;
  const event = eventName ? getAbiItem({ abi: abi3, name: eventName }) : void 0;
  const events = !event ? abi3.filter((x) => x.type === "event") : void 0;
...
function decodeFunctionResult(parameters) {
  const { abi: abi3, args, functionName, data } = parameters;
  let abiItem = abi3[0];
  if (functionName) {
    const item = getAbiItem({ abi: abi3, args, name: functionName });
    if (!item)
...
function encodeDeployData(parameters) {
  const { abi: abi3, args, bytecode } = parameters;
  if (!args || args.length === 0)
    return bytecode;
  const description = abi3.find((x) => "type" in x && x.type === "constructor");
  if (!description)
...
function decodeFunctionData(parameters) {
  ...
  const signature = slice(data, 0, 4);
  const description = abi3.find((x) => x.type === "function" && signature === toFunctionSelector(formatAbiItem2(x)));
  if (!description)
...
function encodeErrorResult(parameters) {
  const { abi: abi3, errorName, args } = parameters;
  let abiItem = abi3[0];
  if (errorName) {
    const item = getAbiItem({ abi: abi3, args, name: errorName });
    if (!item)
...
function encodeFunctionResult(parameters) {
  const { abi: abi3, functionName, result } = parameters;
  let abiItem = abi3[0];
  if (functionName) {
    const item = getAbiItem({ abi: abi3, name: functionName });
    if (!item)
...
async function readContract(client, parameters) {
  const { abi: abi3, address, args, functionName, ...rest } = parameters;
  const calldata = encodeFunctionData({
    abi: abi3,
    args,
    functionName
...
async function simulateContract(client, parameters) {
  const { abi: abi3, address, args, functionName, dataSuffix = typeof client.dataSuffix === "string" ? client.dataSuffix : client.dataSuffix?.value, ...callRequest } = parameters;
  ...
  try {
    ...
    const minimizedAbi = abi3.filter((abiItem) => "name" in abiItem && abiItem.name === parameters.functionName);
    return {
      result,
      request: {
        abi: minimizedAbi,
...
var init_getBlockNumber = __esm({
  "../node_modules/viem/_esm/actions/public/getBlockNumber.js"() {
    init_functionsRoutes_0_6459104538277053();
    init_withCache();
    cacheKey = /* @__PURE__ */ __name2((id) => `blockNumber.${id}`, "cacheKey");
...
function watchContractEvent(client, parameters) {
  const { abi: abi3, address, args, batch = true, eventName, fromBlock, onError, onLogs, poll: poll_, pollingInterval = client.pollingInterval, strict: strict_ } = parameters;
  const enablePolling = (() => {
...
var AccountTypeNotSupportedError;
  ...
  "../node_modules/viem/_esm/actions/wallet/writeContract.js"() {
    ...
    (function(writeContract2) {
      async function internal(client, actionFn, name, parameters) {
        const { abi: abi3, account: account_ = client.account, address, args, functionName, ...request } = parameters;
        if (typeof account_ === "undefined")
          throw new AccountNotFoundError({
...
var init_typedData = __esm({
  "../node_modules/viem/_esm/errors/typedData.js"() {
    ...
    InvalidTypedDataTypeError = class extends BaseError2 {
      static {
        __name(this, "InvalidTypedDataTypeError");
      }
      static {
        __name2(this, "InvalidTypedDataTypeError");
      }
      constructor({ type }) {
...
var staticCursor2;
var NegativeOffsetError2;
var PositionOutOfBoundsError2;
var RecursiveReadLimitExceededError2;
...
__export(SignatureErc8010_exports, {
  ...
  from: /* @__PURE__ */ __name(() => from10, "from"),
...
var InvalidWrappedSignatureError;
...
async function scheduleMulticall2(client, parameters) {
  ...
  const { schedule } = createBatchScheduler({
    ...
    fn: /* @__PURE__ */ __name2((calls) => getAction(client, readContract, "readContract")({
      ...multicallAddress === null ? { code: multicall3Bytecode } : { address: multicallAddress },
      ...rest,
      abi: multicall3Abi,
      args: [calls],
...
__name(scheduleMulticall2, "scheduleMulticall2");
var init_multicall = __esm({
  "../node_modules/viem/_esm/actions/public/multicall.js"() {
    ...
    __name2(scheduleMulticall2, "scheduleMulticall");
  }
});
  ...
  try {
    ...
    return result.map((block2, i) => ({
      ...
      calls: block2.calls.map((call2, j) => {
        const { abi: abi3, args, functionName, to } = blocks[i].calls[j];
        const data = call2.error?.data ?? call2.returnData;
        const gasUsed = BigInt(call2.gasUsed);
        const logs = call2.logs?.map((log) => formatLog(log));
        const status = call2.status === "0x1" ? "success" : "failure";
        const result2 = abi3 && status === "success" && data !== "0x" ? decodeFunctionResult({
          abi: abi3,
          data,
          functionName
        }) : null;
...
function fromAbi(abi3, name, options) {
...
function getSelector(...parameters) {
  const abiItem = (() => {
    if (Array.isArray(parameters[0])) {
      const [abi3, name] = parameters;
      return fromAbi(abi3, name);
    }
    return parameters[0];
  })();
...
function encode3(...parameters) {
  const [abiConstructor, options] = (() => {
    if (Array.isArray(parameters[0])) {
      const [abi3, options2] = parameters;
      return [fromAbi2(abi3), options2];
    }
    return parameters;
  })();
...
function decodeResult(...parameters) {
  const [abiFunction, data, options = {}] = (() => {
    if (Array.isArray(parameters[0])) {
      const [abi3, name, data2, options2] = parameters;
      return [fromAbi3(abi3, name), data2, options2];
    }
    return parameters;
  })();
...
__name(decodeResult, "decodeResult");
function encodeData2(...parameters) {
  const [abiFunction, args = []] = (() => {
    if (Array.isArray(parameters[0])) {
      const [abi3, name, args3] = parameters;
      return [fromAbi3(abi3, name, { args: args3 }), args3];
    }
...
function fromAbi3(abi3, name, options) {
  const item = fromAbi(abi3, name, options);
...
var init_AbiFunction = __esm({
  "../node_modules/ox/_esm/core/AbiFunction.js"() {
    ...
    init_AbiParameters();
    init_Hex();
    __name2(decodeResult, "decodeResult");
...
__name(encodeStaticCall, "encodeStaticCall");
...
__name(decodeAssetResult, "decodeAssetResult");
...
__name(readBalance, "readBalance");
...
__name(getStaticCallAddress, "getStaticCallAddress");
var getBalanceCode;
var staticCallCode;
var staticCallAddressBase;
var transferEventSelector;
var balanceOfFunction;
var decimalsFunction;
var tokenUriFunction;
var symbolFunction;
var staticCallFunction;
var init_simulateCalls = __esm({
  "../node_modules/viem/_esm/actions/public/simulateCalls.js"() {
    ...
    __name2(encodeStaticCall, "encodeStaticCall");
    __name2(tokensFromLogs, "tokensFromLogs");
    __name2(isBalance, "isBalance");
    __name2(decodeAssetResult, "decodeAssetResult");
    __name2(readBalance, "readBalance");
    __name2(getStaticCallAddress, "getStaticCallAddress");
  }
});
...
__export(SignatureErc6492_exports, {
  ...
  from: /* @__PURE__ */ __name(() => from15, "from"),
...
var InvalidWrappedSignatureError2;
...
__name(watchBlockHeaders, "watchBlockHeaders");
var blockFields;
var init_watchBlockHeaders = __esm({
  "../node_modules/viem/_esm/actions/public/watchBlockHeaders.js"() {
    ...
    __name2(watchBlockHeaders, "watchBlockHeaders");
  }
});
...
__name(isValidSiweDateTime, "isValidSiweDateTime");
...
var init_parseSiweMessage = __esm({
  "../node_modules/viem/_esm/utils/siwe/parseSiweMessage.js"() {
    ...
    __name2(isValidSiweDateTime, "isValidSiweDateTime");
    __name2(parseSiweDateTime, "parseSiweDateTime");
...
function publicActions(client) {
  return {
    ...
    watchBlockHeaders: /* @__PURE__ */ __name2((args) => watchBlockHeaders(client, args), "watchBlockHeaders"),
...
function deployContract(walletClient, parameters) {
  const { abi: abi3, args, bytecode, ...request } = parameters;
  const calldata = encodeDeployData({ abi: abi3, args, bytecode });
...
var init_fomo = __esm({
  "_lib/fomo.ts"() {
    "use strict";
    init_functionsRoutes_0_6459104538277053();
    HANDLE_RE = /^[a-z0-9_.\-]{2,32}$/i;
    __name2(normalizeHandle, "normalizeHandle");
    __name2(resolveHandle, "resolveHandle");
...
var init_endorse = __esm({
  "api/endorse.ts"() {
    ...
    splitterAbi = parseAbi(["function endorsed() view returns (bool)"]);
    onRequestPost = /* @__PURE__ */ __name2(async ({ request, env }) => {
      ...
      const launcher = env.MAIN_LAUNCHER;
      const splitter = await pub.readContract({ address: launcher, abi: abi2, functionName: "splitterOf", args: [token] });
      ...
      const logs = await pub.getContractEvents({ address: launcher, abi: abi2, eventName: "CoinLaunched", args: { token }, fromBlock, toBlock: "latest" });
      ...
      let match2 = !!handle && handle.toLowerCase() === x;
      if (!match2 && handle && env.FOMOAPI_KEY) {
        try {
          const { kol } = await resolveHandle(handle, env.FOMOAPI_KEY);
          const linked = kol?.twitter?.replace(/^.*\//, "").replace(/^@/, "").toLowerCase();
          match2 = !!linked && linked === x;
        } catch {
        }
      }
      if (!match2) return jsonResponse({ error: `This coin is for @${ev.kolRef} on FOMO, but you're @${session.x} on X. Add your X handle to your FOMO profile or log in with the matching account.` }, 403);
      const account = privateKeyToAccount(env.SIGNER_PK);
      const wallet = createWalletClient({ account, chain, transport: http(rpc) });
      const hash3 = await wallet.writeContract({ address: launcher, abi: abi2, functionName: "setEndorsed", args: [token, true] });
      await pub.waitForTransactionReceipt({ hash: hash3 });
      return jsonResponse({ ok: true, hash: hash3 });
    }, "onRequestPost");
  }
});
var ALLOWED;
...
var init_img = __esm({
  "api/img.ts"() {
    "use strict";
    init_functionsRoutes_0_6459104538277053();
    ALLOWED = ["prod-fomo-profile-pics.s3.amazonaws.com", "token-media.defined.fi"];
    onRequestGet3 = /* @__PURE__ */ __name2(async ({ request }) => {
      ...
      if (!res) {
        const up = await fetch(target.toString(), { cf: { cacheTtl: 86400 } });
...
var init_resolve = __esm({
  "api/resolve.ts"() {
    ...
    init_functionsRoutes_0_6459104538277053();
    init_fomo();
    onRequestGet4 = /* @__PURE__ */ __name2(async ({ request, env }) => {
      const url = new URL(request.url);
      ...
      const cache = caches.default;
      const cacheKey2 = new Request(`${url.origin}/api/resolve?handle=${handle.toLowerCase()}`, { method: "GET" });
      ...
      try {
        ...
        await cache.put(cacheKey2, res.clone());
        return res;
      } catch (e) {
...
var init_session2 = __esm({
  "api/session.ts"() {
    ...
    init_session();
    init_fomo();
    onRequestGet5 = /* @__PURE__ */ __name2(async ({ request, env }) => {
    ...
    onRequestDelete = /* @__PURE__ */ __name2(async ({ request }) => {
...
var routes;
var init_functionsRoutes_0_6459104538277053 = __esm({
  "../.wrangler/tmp/pages-G4pWXX/functionsRoutes-0.6459104538277053.mjs"() {
    init_callback();
    init_login();
    init_endorse();
    init_img();
...
// .wrangler/tmp/bundle-gAB3UE/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-gAB3UE/middleware-loader.entry.ts
...
*/
//# sourceMappingURL=functionsWorker-0.9713021892588619.js.map
